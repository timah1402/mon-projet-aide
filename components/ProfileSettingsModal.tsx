          ...
          >
            ...
            <View style={tw`p-4 border-b border-gray-200 bg-gray-50`}>
              <View style={tw`flex-row items-center mb-3`}>
                <View style={tw`w-16 h-16 bg-blue-600 rounded-full items-center justify-center mr-4`}>
                ...
                <View style={tw`flex-1`}>
                  ...
                  {userInfo.verified && (
                    <Text style={tw`text-blue-600 text-sm font-medium`}>Compte vérifié ✓</Text>
                  )}
                </View>
              </View>
              
              {/* Bouton Voir plus pour le profil complet */}
              <TouchableOpacity
                style={tw`bg-blue-600 py-2 px-4 rounded-lg flex-row items-center justify-center`}
                onPress={() => {
                  onClose();
                  // Navigation vers le profil complet - à adapter selon votre routing
                  console.log('Navigation vers le profil complet');
                  // router.push('/driver-profile'); // ou autre route
                }}
              >
                <Ionicons name="person-outline" size={16} color="white" style={tw`mr-2`} />
                <Text style={tw`text-white font-medium text-sm`}>Voir mon profil complet</Text>
              </TouchableOpacity>
            </View>
